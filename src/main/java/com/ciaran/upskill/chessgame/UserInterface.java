...
public class UserInterface {
    ...
    public boolean inputMove(String colour) {
    ...
    public boolean isConcession() {
        System.out.println("Confirm game concession (Y/N)");
    ...
    public void displayBoard() {
        for (int i=1; i<9; i++){
            for (int j=1; j<9; j++){
                ChessPiece chessPiece = chessBoard.getPieceByLocation(new BoardCell(i,j));
                if (chessPiece!=null){
    ...
    public int turnMenu() {
        ...
        System.out.println("2 - UserInterface the board");
    ...
    public boolean checkStaleMate(String colour) {
