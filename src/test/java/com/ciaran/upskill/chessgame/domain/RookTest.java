...
public class RookTest {
    ...
    public void setup(){
        ...
        chessPiece = new Rook(new Coordinate('A', '4'),"black");
    ...
    public void test_validate_move_detects_a_legal_move(){
        assertTrue(chessPiece.validateMove(chessBoard, new Coordinate('C', '4')));
    }
    ...
    public void test_validate_move_detects_a_move_passing_through_another_piece(){
        chessBoard.addPiece(new Pawn(new Coordinate('B','4'), "black", "up"));
        assertFalse(chessPiece.validateMove(chessBoard, new Coordinate('C', '4')));
    }
}
