...
public class BishopTest {
    ...
    public void setup(){
        ...
        chessPiece = new Bishop(new Coordinate(1, 4),"black");
    ...
    public void test_validate_move_detects_a_legal_move(){
        assertTrue(chessPiece.validateMove(chessBoard, new Coordinate(3, 6)));
    }
    ...
    public void test_validate_move_detects_a_move_passing_through_another_piece(){
        chessBoard.addPiece(new Pawn(new Coordinate(2,5), "black", "up"));
        assertFalse(chessPiece.validateMove(chessBoard, new Coordinate(3, 6)));
    }

    @Test
    public void test_move_piece_updates_piece_and_board(){
        Coordinate finish = new Coordinate(4,7);
        try {
